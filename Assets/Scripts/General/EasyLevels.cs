...
public class EasyLevels : MonoBehaviour {
	...
	/* Motor principal de los niveles de dificultad facil */
	...
	void Update () {
		...
		if (vars.d_easy && vars.level == 4 && vars.street) {
		...
		}else if (vars.d_easy && vars.level == 7 && vars.street) {
		...
		}else if (vars.d_easy && vars.level == 10 && vars.street){
